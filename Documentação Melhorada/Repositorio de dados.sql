 ...
 * Author :       D031092
 *
 * Date Created : Monday, August 21, 2017 00:47:01
...
CREATE TABLE AGENDAPASTORAL(
    ...
    PRIVADO           varchar(1)       DEFAULT 'N' NULL,    
...
CREATE TABLE BENEFICIARIO(
    ...
    TIPOPESSOA      varchar(1)      DEFAULT 'F' NULL,
...
CREATE TABLE EVENTOS(
    ...
    BANNER            image            NULL,
    PRIVADO           varchar(1)       DEFAULT 'N' NULL,
    PASTORPRESENTE    varchar(1)       DEFAULT 'S' NULL,
...
CREATE TABLE INTEGRANTES(
    ...
    CODBENEFICIARIO    int            NOT NULL,
    CODMINISTERIO      int            NOT NULL,
    ATIVO              varchar(1)     DEFAULT 'S' NULL,
...
CREATE TABLE MENSAGEMENTRANTE(
    ...
    PERMITERETORNO     varchar(1)        DEFAULT 'S' NOT NULL,
    TELEFONECONTATO    varchar(16)       NULL,
    DATACONTATO        date              DEFAULT getdate() NULL,
    FREQUENTA          varchar(1)        DEFAULT 'S' NULL,
...
CREATE TABLE PARAMETROS(
    ...
    EXIBIRLOCALIZACAO    varchar(1)      DEFAULT 'S' NOT NULL,
